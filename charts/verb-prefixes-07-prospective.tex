...
Disjunct\rlap{\quad{}+}	& Asp.\rlap{ +}		& Subj.\rlap{ →}& Prefixes				&\Df{d}-\Ff{s}-\If{i}\rlap{-}	&\Df{d}-\If{i}\rlap{-}	&\Ff{s}-\If{i}\rlap{-}	&\Df{d}-				&\Df{d}-\Ff{s}\rlap{-}			&\Ff{s}-				&\If{i}-	&—\\
\midrule
—			&\Rf{w}-\Af{g}-\Mf{g̱}-	&\Sf{i}-	&\Rf{w}-\Af{g}-\Mf{g̱}-\Sf{i}-		&⁎				&⁎			&⁎			&\Af{g}\Ef{a}\Mf{g̱}\Sf{i}\Df{d}\Ef{a}	&\Af{g}\Ef{a}\Mf{g̱}\Sf{ee}\df{\Ff{s}}	&\Af{g}\Ef{a}\Mf{g̱}\Sf{i}\Ff{s}\Ef{a}	&⁎		&\Af{g}\Ef{a}\Mf{g̱}\Sf{ee}\\
...
Disjunct\rlap{\quad{}+}	& Asp.\rlap{ +}		& Subj.\rlap{ →}& Prefixes				&\Df{t}-\Ff{s}-\If{i}\rlap{-}	&\Df{t}-\If{i}\rlap{-}	&\Ff{s}-\If{i}\rlap{-}	&\Df{t}-					&\Df{t}-\Ff{s}\rlap{-}				&\Ff{s}-					&\If{i}-	&—\\
\midrule
—			&\Rf{ʷ}-\Af{k}-\Mf{q}-	&\Sf{i}-	&\Rf{ʷ}-\Af{k}-\Mf{q}-\Sf{i}-		&⁎				&⁎			&⁎			&\Af{k}\Ef{a}.\Mf{q}\Sf{i}.\Df{t}\Ef{a}		&\Af{k}\Ef{a}.\Mf{q}\Sf{iː}\df{\Ff{s}}		&\Af{k}\Ef{a}.\Mf{q}\Sf{i}.\Ff{s}\Ef{a}		&⁎		&\Af{k}\Ef{a}.\Mf{q}\Sf{iː}\\
